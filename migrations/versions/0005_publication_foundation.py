...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("origin", sa.String(length=20), server_default="original", nullable=False),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("publication_id", "locale"),
    )
    op.create_index(
        "ix_publication_localizations_publication_id",
        "publication_localizations",
        ["publication_id"],
    )
